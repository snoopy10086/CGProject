...
## Keboard Operation
![image-20220129221949935](README.assets/image-20220129221949935.png)
...
- `1` `2` `3` `4` `5` `6` `7` `8` : 分别控制0-7号光源的开与关（视觉效果为灯的开关）；
- `9`：控制光的色温循环变化；
...
- `W` ：后移物体
- `Backspace` ：删除物体
- `h` ：切换创造月饼合成类shape创建还是其他shape的创建
- `j` ：在同一shape创建模式下切换不同的shape，如在月饼、月饼皮、馅料间切换
